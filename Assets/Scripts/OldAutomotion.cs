...
{
    public class OldAutomotion : MonoBehaviour
    {
    ...
    public struct PlatformCell
    {
        public Vector2Int position;
        public PlatformType type;
        public HashSet<PlatformCell> reachableNeighbours;
        public HashSet<PossibleActions> possibleActions; // Replace Set with HashSet

        public PlatformCell(Vector2Int position, PlatformType type)
        {
            this.position = position;
            this.type = type;
            reachableNeighbours = new HashSet<PlatformCell>();
        ...
        public override string ToString()
        {
            ...
            {
                possibleActionsString += action + ", ";
            }
            return "PlatformCell: " + position + " " + type + ": actions = " + possibleActionsString;
        }

        public override bool Equals(object obj)
        {
            return obj is PlatformCell cell &&
    ...
    {
        // list of cells composing the platform
        public Dictionary<Vector2Int, PlatformCell> cells; // Replace Map with Dictionary

        public Platforms(bool nothing)
        {
            cells = new Dictionary<Vector2Int, PlatformCell>(); // Replace Map with Dictionary
        }

        public void AddCell(PlatformCell cell)
        {
            cells.Add(cell.position, cell); // Replace Map method with Dictionary method
        }

        public PlatformCell this[Vector2Int position]
        {
            get
            {
        ...
        public override string ToString()
        {
            return "Platforms: " + cells.ToString();
        }
    }
}